...
public class ChangeProfile implements Serializable
{
	...
	public User createUserEntityFromForm(User persistentUser)
	{
		return new User(
			...
			persistentUser.getSzzBirthMonth(),
			persistentUser.getSzzBirthDay(),
			...
			persistentUser.getL(),
			persistentUser.getSzzEntryDay(),
			persistentUser.getSzzEntryMonth(),
			persistentUser.getSzzEntryYear(),
			persistentUser.getSzzExitDay(),
			persistentUser.getSzzExitMonth(),
			persistentUser.getSzzExitYear(),
