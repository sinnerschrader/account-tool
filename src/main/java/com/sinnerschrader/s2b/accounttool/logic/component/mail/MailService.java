...
public class MailService {
    ...
    public boolean sendMailForRequestAccessToGroup(LdapUserDetails currentUser, List<User> receipients,
    ...
    public void sendMailForGroupChanged(List<User> recipients, LdapUserDetails currentUser, Group group, User user, Change change) {
        final Map<String, Object> params = new HashMap<>();
        params.put("currentUser", currentUser);
        ...
        sendMail(recipients,
            "mail/groupChanged.subject.txt", "mail/groupChanged.body.txt", params);
    }
